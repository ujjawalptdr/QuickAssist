...
import img5 from "./imagesHome/img5.jpg";
...
const FeatureCard = ({ icon, title, description }) => (
    <motion.div
        className="bg-white/80 backdrop-blur-md rounded-xl p-6 w-full sm:w-72 shadow-xl hover:shadow-2xl"
            ...
            <div className="flex flex-col md:flex-row min-h-screen  overflow-hidden">
                ...
                <div className="w-full md:w-[70%] flex flex-col justify-center items-center text-center px-6 sm:px-12 py-12">
                    ...
                    <Link to="/services/servicePage">
                        <motion.button
                            className="px-8 py-3 bg-yellow-400 hover:bg-yellow-500 text-white font-semibold rounded-full shadow-md"
